...
wms=( 2bwm 2wm 9wm aewm afterstep ahwm alopex amiwm antiwm awesome berry blackbox bspwm catwm clfswm ctwm cwm dminiwm dragonflywm dwm echinus \
...
print-song(){
    color-echo "PLAYING" "$(mpc current)"
}
